        ...
        <ScrollView style={styles.Header}>
            ...
            <View style={styles.HeaderRowContainer}>
                ...
                <View style={styles.TitlesContainer}>
                    <Subtitulo text= 'Armazenamento e Comercialização de GLP'/>
                    <ProximaPagina text = "Próx: Campo de Observações" />
                </View>
            </View>
            ...
            <View style={styles.container}>
                <Table borderStyle={{borderWidth: 0}} >
                    ...
                    <OptionsRow title = 'Retirar do interior da edificação' color = {OptionsOffsetColor} />
                    <OptionsRow title = 'Utiliza central de GLP' />
                    <OptionsRow title = 'Distâncias de segurança atendem' color = {OptionsOffsetColor} />
                    <OptionsRow title = 'Outros itens observados' />

                </Table>
            </View>

            <BottomMenu navigation = {navigation} backwards = "RelatorioDeVistoria_11" forwards = "RelatorioDeVistoria_13" />
